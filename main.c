...
int main(int argc, char *argv[]) {
    ...
    // Conecta os sinais de clique dos botões aos callbacks
    ...
    // Cria um layout de caixa vertical para organizar os botões
    ...
    // Adiciona a caixa de layout à janela principal
